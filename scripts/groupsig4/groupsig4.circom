...
/*
  ...
  - (x - addr1)(x - addr2)(x - addr3)(x - addr4) == 0
...
template Main(n, k) {
    ...
    signal temp1;
    signal temp2;
    temp1 <== (myAddr - addr1) * (myAddr - addr2);
    temp2 <== temp1 * (myAddr - addr3);
    0 === temp2 * (myAddr - addr4);
...
component main {public [addr1, addr2, addr3, addr4, msg]} = Main(64, 4);